//-------------------------------------------------------------------------------------------------
//-------------------------------------------------------------------------------------------------
// Autor: Daniel Benavides Belmonte 
// Fecha: 22/09/2022
// Fichero: Beacons.ino
...
void setup() {
  ...
  Serial.begin(115200); //Iniializar puerto serie
  
  Bluefruit.begin(); //Inizializar libreria micro

  Serial.println("PRUEBAS iBeacon"); //Avisamos de que comenzamos la prueba

  Serial.println("El nombre del iBeacon es Beacon_Daniel"); //Informamos de cual será el nombre para poder encontrarlo de manera más sencilla
  Bluefruit.setName("Beacon_Daniel"); //Le asignamos un nombre a los iBeacons que enviaremos
